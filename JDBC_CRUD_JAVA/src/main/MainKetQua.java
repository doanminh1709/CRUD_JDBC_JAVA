	...
	public static void findAllKetQua() {
		...
		try {
			...
			for(KetQua kq : listKQ) {
				System.out.print(kq.getSinhVien().getHoTen() + " ");
				System.out.print(kq.getSinhVien().getMaSV()+ " ");
				System.out.print(kq.getMonHoc().getMaMH()+" ");
				System.out.print(kq.getMonHoc().getTenMH()+ " ");	
				System.out.print(kq.getDiemThi()+" ");
				System.out.println();
			}
		} catch (SQLException e) {
			e.printStackTrace();
